...
window = tk.Tk()
window.title("RJV Player")
window.geometry("600x500")
window.config(background='#add8e6')


l_music_player = tk.Label(window, text="RJV Player Music", font=("TkDefaultFont", 30, "bold"))
